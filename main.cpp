...
int main() {
    ...
    world.add(make_shared<sphere>(point3(0, 2, 0), 2, material1));

    auto material2 = make_shared<diffuse_light>(color(0.5,0.5,0.5), 20.0);

    world.add(make_shared<sphere>(point3(0, 6, 0), 1, material2));
